...
public class MySearchGuestRecyclerViewAdapter extends RecyclerView.Adapter<MySearchGuestRecyclerViewAdapter.ViewHolder> {

    private final SetOnRecyclerViewClickListener setOnRecyclerViewClickListener;
    private List<Post_Info> mValues;


    public MySearchGuestRecyclerViewAdapter(List<Post_Info> items, SetOnRecyclerViewClickListener setOnRecyclerViewClickListener) {
        mValues = items;
